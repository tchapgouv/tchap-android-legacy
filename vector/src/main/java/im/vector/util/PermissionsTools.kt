...
private fun checkPermissions(permissionsToBeGrantedBitMap: Int,
    ...
    if (null == activity) {
        ...
        if (PERMISSION_CAMERA == permissionsToBeGrantedBitMap and PERMISSION_CAMERA && hasToAskForPermission(activity, Manifest.permission.CAMERA)) {
